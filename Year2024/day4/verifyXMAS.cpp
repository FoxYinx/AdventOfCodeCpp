...
bool horizontal(int i, int j, vector<vector<char>> &tableau) {
    ...
    if (tableau[i][j] == 'X' && tableau[i][j + 1] == 'M' && tableau[i][j + 2] == 'A' && tableau[i][j + 3] == 'S')
        h = true;
    if (tableau[i][j] == 'S' && tableau[i][j + 1] == 'A' && tableau[i][j + 2] == 'M' && tableau[i][j + 3] == 'X')
        h = true;
    return h;
}
...
bool vertical(int i, int j, vector<vector<char>> &tableau) {
    ...
    if (tableau[i][j] == 'X' && tableau[i + 1][j] == 'M' && tableau[i + 2][j] == 'A' && tableau[i + 3][j] == 'S')
        v = true;
    if (tableau[i][j] == 'S' && tableau[i + 1][j] == 'A' && tableau[i + 2][j] == 'M' && tableau[i + 3][j] == 'X')
        v = true;
    return v;
}
...
bool diag_right(int i, int j, vector<vector<char>> &tableau) {
    ...
    if (tableau[i][j] == 'X' && tableau[i + 1][j + 1] == 'M' && tableau[i + 2][j + 2] == 'A' &&
        tableau[i + 3][j + 3] == 'S')
        dr = true;
    if (tableau[i][j] == 'S' && tableau[i + 1][j + 1] == 'A' && tableau[i + 2][j + 2] == 'M' &&
        tableau[i + 3][j + 3] == 'X')
        dr = true;
    return dr;
}
